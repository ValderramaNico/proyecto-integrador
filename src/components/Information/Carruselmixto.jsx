...
function Carruselmixto() {
  const slides = [
    ...
    },
    {
      ...
      descripcion:
        "Opta por regletas programables o inteligentes que corten automáticamente la energía a dispositivos seleccionados en horarios determinados o cuando detecten que no hay consumo, optimizando el ahorro nocturno.",
    },
    {
      tipo: "texto",
      fondo: "yellow",
      ...
      descripcion:
        "Utiliza programas cortos y de agua fría para lavar ropa, y carga la lavadora o lavavajillas completamente antes de usarlos. Evita el uso de la secadora: tiende la ropa siempre que sea posible.",
    },
  ];
  ...
  return (
    <div>
      <div className={styles.carrusel}>
        <div className={styles["carrusel-slide"]}>
          {slide.tipo === "imagen" ? (
            <img
              src={slide.src}
              alt={`slide-${indice}`}
